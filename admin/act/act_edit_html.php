        ...
        <div class="bag clearfix">
            <div class="main_bag scroll">
                <form action="" method="POST" strcolling="yes">
                    <h3 class="title">编辑活动</h3>
                    <div class="item">
                        <span>活动名称</span>
                        <input type="text" name="act_name" value="<?php echo $act_info['act_name'] ?>">
                    </div>
                    <div class="item">
                        <span>活动地点</span>
                        <input type="text" name="place" value="<?php echo $act_info['place'] ?> ">
                    </div>
                    <div class="item_type">
                        <span>活动类型</span>
                        <div class="select" name="type">
                            <?php echo make_select('type', $types,  $act_info['type']) ?>
                        </div>
                    </div>
                    <div class="item des">
                        <p>活动介绍</p>
                        <textarea name="description" rows="8" cols="5" maxlength="200"><?php echo $act_info['description'] ?></textarea>
                    </div>
                    <div class="item time">
                        <span>开始时间</span>
                        <i class="iconfont icon-clock" id="time1"></i>
                        <input type="text" id="some_class_1" class="some_class" name="begin_time" value="<?php echo  $act_info['begin_time'] ?> ">
                        <span>结束时间</span>
                        <i class="iconfont icon-clock" id="time2"></i>
                        <input type="text" id="some_class_2" class="some_class" name="end_time" value="<?php echo $act_info['end_time'] ?> ">
                    </div>
                    <div class="item other">
                        <span>活动人数</span>
                        <input type="text" name="count" value="<?php echo $act_info['count'] ?> ">
                        <span>活动学时</span>
                        <input type="text" name="reward" value="<?php echo $act_info['reward'] ?> " ">
                    </div>
                    <div class=" field">
                        <input class="submit" type="submit" value="保存" onclick="showPopup()" />
                        <a href="./act.php" class="cancel">取消</a>
                    </div>
                </form>
            </div>
        </div>
