...
<head>
    ...
    <style>
        ...
        /* 设置table每一列的样式 */
        .user tbody td:nth-child(1) {
            padding-left: 10px;
            text-align: left;
        }

        .user tbody td:nth-child(3) {
            white-space: nowrap;
            overflow: hidden;
...
<body>
    ...
    <div class="content">
        ...
        <div class="bag clearfix">
            <div class="main_bag">
                <div class="top">
                    <form action="./volunteer.php" method="POST" onsubmit="return check(this)">
                        <i class="iconfont icon-search"></i>
                        <input type="submit" class="search" name="submit" value="搜索">
                        <input type="text" class="search_title" name="keyword" placeholder="请输入志愿者名称" value="<?php if (isset($_POST['keyword'])) {
                                                                                                                    print $_POST['keyword'];
                                                                                                                } ?>">
                    </form>
                </div>
                            ...
                            <?php if (!empty($user_info)) : ?>
                                <?php foreach ($user_info as $row) : ?>
                                    <tr>
                                        ...
                                        <td title="<?php echo $row['speciality'] ?>"><?php echo $row['speciality'] ?></td>
