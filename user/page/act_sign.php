...
if (isset($_GET['id'])) {
    ...
    if ($result = mysqli_query($link, $sql)) {
        echo "<script language=javascript>alert('报名成功，可在个人中心查看活动！');window.location='../person/p_act.php'</script>";
        ...
        echo "<script language=javascript>alert('已报名该活动，请不要重复报名！');window.location='../index.php'</script>";
    }
}
require './act3_html.php';
